...
n=int(input("Enter the number of foldes:"))
final_thickness_m=num_layers(n)
print(f"The thickness of paper after forlding for {n} times is :{final_thickness_m:.3f}m")